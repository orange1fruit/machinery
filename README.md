...
[![godoc for RichardKnop/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/orange1fruit/machinery/v1)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/orange1fruit/machinery)](https://goreportcard.com/report/github.com/orange1fruit/machinery)
[![GolangCI](https://golangci.com/badges/github.com/orange1fruit/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for RichardKnop/machinery](https://sourcegraph.com/github.com/orange1fruit/machinery/-/badge.svg)](https://sourcegraph.com/github.com/orange1fruit/machinery?badge)
...
```go
import (
  "github.com/orange1fruit/machinery/v2"
  ...
  locksiface "github.com/orange1fruit/machinery/v2/locks/iface"
)
...
```sh
go get github.com/orange1fruit/machinery/v1
```

Or to get experimental v2 release:

```sh
go get github.com/orange1fruit/machinery/v2
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/orange1fruit/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/orange1fruit/machinery/v1/log` package:
...
import (
  ...
  "github.com/orange1fruit/machinery/v1"
)
